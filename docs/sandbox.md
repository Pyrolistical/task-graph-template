...
- the extension is the claimed state's too, chosen through `STATE_TOOLS`. The path is absolute and points into the orchestrator's own checkout, because the child's cwd is the worktree and the extensions do not live in the driven repo.
