...
flowchart LR
  ...
  subgraph tasks["tasks"]
    ...
    orchestrator_tasks_policy_recent_ts["policy/recent"]
  ...
  orchestrator_tasks_app_task_graph_ts --> orchestrator_tasks_policy_recent_ts
  ...
  orchestrator_tasks_policy_recent_ts --> orchestrator_tasks_domain_rows_ts
