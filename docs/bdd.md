...
929 behaviours across 41 suites.
...
## orchestrator/adapters/pi-agents.test.ts
...
#### a model pi does not know is refused by name
...
## orchestrator/domain/health.test.ts
...
#### an api with no known health endpoint is refused by name
...
#### a task in BLOCKED_DESIGN will not take a pass

- **Given** a task waiting to be designed, with nothing left to wait on
- **When** a pass is decided on it
- **Then** it is turned away as not valid from BLOCKED_DESIGN

#### a task in BLOCKED_DESIGN will not take a fail

- **Given** a task waiting to be designed, with nothing left to wait on
- **When** a fail is decided on it
- **Then** it is turned away as not valid from BLOCKED_DESIGN

#### a task in BLOCKED_DESIGN will not take a hold

- **Given** a task waiting to be designed, with nothing left to wait on
- **When** a hold is decided on it
- **Then** it is turned away as not valid from BLOCKED_DESIGN

#### a task in BLOCKED_DESIGN will not take a resume

- **Given** a task waiting to be designed, with nothing left to wait on
- **When** a resume is decided on it
- **Then** it is turned away as not valid from BLOCKED_DESIGN

#### a task in BLOCKED_DESIGN will not take feedback

- **Given** a task waiting to be designed, with nothing left to wait on
- **When** feedback is decided on it
- **Then** it is turned away as not valid from BLOCKED_DESIGN

#### a task in BLOCKED_DESIGN will not take an abort
...
## orchestrator/policy/toggles.test.ts
