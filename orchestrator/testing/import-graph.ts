...
const GROUPS = [
  ...
  { dir: "orchestrator/adapters", title: "adapters" },
  { dir: "orchestrator/app/ports", title: "app/ports" },
  { dir: "orchestrator/app", title: "app" },
  { dir: "orchestrator/policy", title: "policy" },
  { dir: "orchestrator/domain", title: "domain" },
...
function labelOf(modulePath: string): string {
  return path.basename(modulePath, ".ts");
}
...
export function render(modules: string[], edges: Edge[]): string {
  ...
  for (const group of GROUPS) {
    ...
    for (const member of members) {
      out.push(`    ${idOf(member)}["${labelOf(member)}"]`);
    }
    out.push("  end");
  }
