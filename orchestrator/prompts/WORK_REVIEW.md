Read `../ASSIGNMENT.md` and attack the work committed against it.

1. Understand the goal
2. Read the commits and the `## Implementation Notes`
3. Judge them against the acceptance criteria
4. Name the defects that would sink it

- A finding is behaviour this work gets wrong, or an acceptance criterion it
  does not meet. Code you would have written differently is not a finding. You
  did not write this code: judge what it does, not the reasoning that produced
  it.
