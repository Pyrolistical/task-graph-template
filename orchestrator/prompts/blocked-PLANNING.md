...
A plan you can still write is not a wall. If you can decompose this task into
executable todos despite whatever stopped you, do that: replace the blocked
block in `../ASSIGNMENT.md` with
