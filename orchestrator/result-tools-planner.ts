...
const submit = defineTool({
  ...
  label: "Submit",
  description:
    "Finish planning and hand in your plan. Call it as your last action, with nothing after it.",
  promptSnippet: "End the task by calling submit",
  promptGuidelines: [
    "Call submit only when the plan the assignment asks of you is genuinely done.",
