import type { AssignmentDiff } from "../../vocabulary/assignment.ts";
import {
  type WorktreeStatus,
  detailOf,
  varsOf,
  worktreeIssue,
} from "../../workspaces/domain/guard.ts";
import type { IssueName } from "../../prompting/domain/issues.ts";
import { type StopReason, LOOP_LIMIT } from "../../agents/domain/protocol.ts";
import {
  type ResultCall,
  resultFromCall,
} from "../../agents/domain/results.ts";
